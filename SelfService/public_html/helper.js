...
function buildHomeNavigationPage(oj, rootViewModel) {
    ...
    navDataLeft.push( {
        name : getTranslation("pages.generalSetup"), id : 'summaryGeneralSetup', iconClass : 'oj-navigationlist-item-icon fa fa-plane'
    });
    
    navDataLeft.push( {
        name : getTranslation("pages.gradeRules"), id : 'summaryGradeRules', iconClass : 'oj-navigationlist-item-icon fa fa-plane'
    });
    
    navDataLeft.push( {
        name : getTranslation("pages.personRules"), id : 'summaryPersonRules', iconClass : 'oj-navigationlist-item-icon fa fa-plane'
    });
...
'summaryGeneralSetup' :  {
            label : 'General Setup', value : 'Tickets_Soultion/General_Setup/summaryGeneralSetup', title : 'Ticket Request'
        },
'createGeneralSetup' :  {
            label : 'Creat General Setup', value : 'Tickets_Soultion/General_Setup/createGeneralSetup', title : 'Ticket Request'
        },
'viewGeneralSetup' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/General_Setup/viewGeneralSetup', title : 'Ticket Request'
        },
'editGeneralSetup' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/General_Setup/editGeneralSetup', title : 'Ticket Request'
        },
'summaryGradeRules' :  {
            label : 'Grade Rules', value : 'Tickets_Soultion/Grade_Rules/summaryGradeRules', title : 'Ticket Request'
        },
'createGradeRules' :  {
            label : 'Creat Grade Rules', value : 'Tickets_Soultion/Grade_Rules/createGradeRules', title : 'Ticket Request'
        },
'viewGradeRules' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/Grade_Rules/viewGradeRules', title : 'Ticket Request'
        },
'editGradeRules' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/Grade_Rules/editGradeRules', title : 'Ticket Request'
        },
'summaryPersonRules' :  {
            label : 'Grade Rules', value : 'Tickets_Soultion/Person_Rules/summaryPersonRules', title : 'Ticket Request'
        },
'createPersonRules' :  {
            label : 'Creat Grade Rules', value : 'Tickets_Soultion/Person_Rules/createPersonRules', title : 'Ticket Request'
        },
'viewPersonRules' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/Person_Rules/viewPersonRules', title : 'Ticket Request'
        },
'editPersonRules' :  {
            label : 'View General Setup', value : 'Tickets_Soultion/Person_Rules/editPersonRules', title : 'Ticket Request'
        }    
    };
