...
define(['config/serviceconfig', 'util/commonhelper'], function (serviceConfig, commonHelper) {
    ...
    function services() {
        ...
        self.getGenralSummary = function () {
            var serviceURL = paasServiceHost + "generalSetup";
            var headers = {
        ...
        self.addGenralSummary = function (payload) {
            var serviceURL = paasServiceHost + "generalSetup";
            var headers = {
            };
        ...
        self.editGenralSummary = function (payload) {
            var serviceURL = paasServiceHost + "generalSetup";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.deleteGenralSummary = function (payload) {
            var serviceURL = paasServiceHost + "generalSetup";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA==";
            return serviceConfig.callDeleteApexService(serviceURL, payload, serviceConfig.contentTypeApplicationJSON, true, headers);
            //return serviceConfig.callDeleteApexService(serviceURL, serviceConfig.contentTypeApplicationJSON, headers, true);
        };
        self.getGradeRule = function (gradeId, effectiveDate) {
            var serviceURL = paasServiceHost + "gradeRULES";
            var headers = {
                gradeID : gradeId, effectiveDate : ""
            };
            //            headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
            return serviceConfig.callGetApexService(serviceURL, serviceConfig.contentTypeApplicationJSON, headers, true);
        };
        self.addGradeRule = function (payload) {
            var serviceURL = paasServiceHost + "gradeRULES";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.editGradeRULES = function (payload) {
            var serviceURL = paasServiceHost + "gradeRULES";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.deleteGradeRULES = function (payload) {
            var serviceURL = paasServiceHost + "gradeRULES";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA==";
        ...
        //personRules
        self.getPersonRules = function (personNum, effectiveDate) {
            var serviceURL = paasServiceHost + "personRules";
            var headers = {
                personNumber : personNum, effectiveDate : effectiveDate
            };
            //            headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
            return serviceConfig.callGetApexService(serviceURL, serviceConfig.contentTypeApplicationJSON, headers, true);
        };
        self.addPersonRules = function (payload) {
            var serviceURL = paasServiceHost + "personRules";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.editPersonRules = function (payload) {
            var serviceURL = paasServiceHost + "personRules";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.deletePersonRules = function (payload) {
            var serviceURL = paasServiceHost + "personRules";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA==";
        ...
        self.getRoutsPrice = function (RoutesName) {
            var serviceURL = paasServiceHost + "RoutsPrice";
            var headers = {
        ...
        self.addRoutsPrices = function (payload) {
            var serviceURL = paasServiceHost + "RoutsPrice";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.editRoutsPrices = function (payload) {
            var serviceURL = paasServiceHost + "RoutsPrice";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA=="
        ...
        self.deleteRoutsPrices = function (payload) {
            var serviceURL = paasServiceHost + "RoutsPrice";
            var headers = {
            };
            //  headers.Authorization = "Basic YW1yby5hbGZhcmVzQGFwcHNwcm8tbWUuY29tOkFwcHNwcm9AMTIzNA==";
